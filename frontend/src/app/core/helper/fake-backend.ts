/**
 * Implementamos un login sin backend que lo respalde, por lo tanto hemos creado
 * una versión muy simplificada de un fake backend con los endpoints que necesitamos
 * para hacerlo funcionar. La función login nos devuelve un token y el usuario en el
 * body que coincidirá con los parámetros que reciba. Si los parámetros no son
 * correctos devolverá un error. El logout simplemente nos devuelve un true.
 */
